...
| <a name="input_slack_channel_id"></a> [slack\_channel\_id](#input\_slack\_channel\_id) | The chanel ID for slack workspace where notifications are sent | `string` | n/a | yes |
...
| <a name="input_slack_workspace_id"></a> [slack\_workspace\_id](#input\_slack\_workspace\_id) | The workspace ID for slack account to be used for notifications | `string` | n/a | yes |
